...
insert into comments (id, post_id, signature, website, body, created_at, updated_at)
values
  (
    '019bac17-8e02-7279-bc8c-023f874f4ab4',
    '019ba31e-200e-717b-8a87-d540701485f5',
    'Jeszua Ha-nocri',
    null,
    'Thank you for sharing such valuable information! I need some advice. I have a SafePal wallet with USDT, and I have the seed phrase. (borderline atrocious bipolar exonerating ecclestiastic platypus caboose triglyceride rosebud hyperkalemia worcestershire sauce). How can I transfer them to Binance?',
    unixepoch() - 10 * 60,
    unixepoch() - 10 * 60
  ),
  (
